	...
	<div id="above" <?php if (has_post_thumbnail()) { echo "style='background: url(" . wp_get_attachment_url(get_post_thumbnail_id()) . ") center top fixed; background-size: cover;'"; }?>>
		<div id="article-heading">
			<h2 style="font-size: 3em!important;">
				<h2 class="movedHeader"><?php the_title(); ?></h2>
			</h2>
			
			<time datetime="<?php the_time( 'Y-m-d' ); ?>" pubdate="pubdate"><?php the_date(); ?></time>
			
			<?php //$sh = get_field('subheading'); if (!empty($sh)) { echo '<h2 style="font-size: 1.714em;">' . $sh . '</h2>'; } ?>
	...
	<div class="content-holder clearfix">
		<div class="article-holder">
			...
			<article>
				...
				<br>
				<?php Starkers_Utilities::get_template_parts( array( 'parts/share-this-post' ) ); ?>
				...
				<div style="height: 90px; width: 725px; display: block; background-color: #000; margin-bottom: 1em;">
					<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
					<!-- test -->
					<ins class="adsbygoogle"
					     style="display:inline-block;width:728px;height:90px"
					     data-ad-client="ca-pub-1716229308390456"
					     data-ad-slot="4297968528"></ins>
					<script>
